...
REVIEW_RESP = json.dumps({"choices": [{"message": {"content": '{"approved": true, "review_comments": "Looks good"}'}}], "usage": {"total_tokens": 50}}).encode()
...
def test_phase_6b_flow(mock_complete, mock_db):
    mock_complete.side_effect = [
        ...
        {"content": '{"approved": true, "review_comments": "Looks good"}', "usage": {"total_tokens": 50}}
    ]
