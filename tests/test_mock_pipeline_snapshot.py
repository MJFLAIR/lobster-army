...
def test_mock_pipeline_snapshot(mock_complete, mock_firestore):
    # Contract-aligned deterministic mock sequence: PM -> Coder -> Reviewer
    mock_complete.side_effect = [
        {
            "content": "{\"plan\": [{\"step_order\": 1, \"agent\": \"feature_coder\", \"instruction\": \"Implement hello world\"}]}",
            "usage": {"total_tokens": 80},
        },
        {
            "content": "{\"diff\": \"--- a/hello.py\\n+++ b/hello.py\\n@@ -0,0 +1 @@\\n+print(\\\"hello world\\\")\\n\", \"tool_calls\": []}",
            "usage": {"total_tokens": 100},
        },
        {
            "content": "{\"approved\": true, \"review_comments\": \"Looks good\", \"comments\": []}",
